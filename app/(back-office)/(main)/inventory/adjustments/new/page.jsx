...
const NewAdjustment = () => {
  ...
  return (
    <div>
      {/* Header */}
      <FormHeader title="New Adjustment" href="/inventory/items" />
      {/* Tabs */}
      <div
        class="border-b border-gray-200 dark:border-gray-700 w-full max-w-4xl px-4 py-2 bg-white border shadow rounded
                 mx-auto my-4"
      >
