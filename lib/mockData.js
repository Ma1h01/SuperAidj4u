...
const generateWarehouseAdjustments = (warehouseId, warehouseName) => {
  const products = [
    ...
    { id: "PRD011", name: "Smart Speaker", basePrice: 199.99 },
    { id: "PRD012", name: "Graphics Card RTX", basePrice: 799.99 },
    { id: "PRD013", name: "NVMe SSD 2TB", basePrice: 249.99 },
    { id: "PRD014", name: "Gaming Chair Pro", basePrice: 349.99 },
    { id: "PRD015", name: "Wireless Earbuds", basePrice: 99.99 },
  ];
...
export const getMockWarehouses = () => mockWarehouses;
export const getMockInventoryAdjustments = () => mockInventoryAdjustments;
export const addMockWarehouse = (id, name) => {
  const newWarehouse = {
    id,
    name,
  };
  mockWarehouses.push(newWarehouse);
  mockInventoryAdjustments.push(...generateWarehouseAdjustments(id, name));
};
